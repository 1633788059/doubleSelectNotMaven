...
<html>
  <head>
	...
	<script type="text/javascript" src="js/volunteer/volunteermessage/teachermessageupdate.js"></script>
	<style>
		.textbox{
			height:20px;
			margin:0;
		...
		<script type="text/javascript">
				...
				$("#volunteermessage").datagrid({
					url:'volunteer/volunteermessage/search?teachersno='+teachersno+"&rank=4", 
				});
 ...
 <div  style="height:10%;width:100%;float:left">
	 ...
	 <div  style="height:90%;width:100%;float:left;display:none" id="teacherUpdate">
