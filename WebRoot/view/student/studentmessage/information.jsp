			...
			<td align="center" colspan="2" valign="top" height="95%">
				<div class="tab_container" style="text-align:left;" >
					...
					<div id='content_1' class='tab-content tab-content-show' > 
						<iframe id='frame_1' width='99%' height='99%' src='student/studentmessage/studentmessage?studentSno=<%=sno %>&role=1' frameborder='0' scrolling=''></iframe>
						</div>
					...
					<input  type="hidden" id="urls" name="urls" value="student/studentmessage/studentmessage?studentSno=<%=sno %>&role=1,student/studentmessage/updateinformation?studentSno=<%=sno %>,/student/stu.xsxj.xjda.jcxx.html?menucode=JW13020105,/student/stu.xsxj.zcxx.html?menucode=JW130202" />
				</div>
			</td>
		</tr>
	</table>		
