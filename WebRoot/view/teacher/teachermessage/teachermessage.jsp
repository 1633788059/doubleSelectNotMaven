  ...
  <head>
	...
	<style>
		...
		<script type="text/javascript">
			...
			function showMessage(){
				...
				if("null"==sno&&null!=teacherId){
					url_teacher="teacher/teachermessage/searchteacher?teacherId="+teacherId;
				}
				if(null!=sno&&"null"==teacherId){
					url_teacher="teacher/teachermessage/searchTeacherBysno?teacherSno="+sno;
				}
				$.ajax({
					url: url_teacher,
					type:"get" ,
					...
					success:function(data){
						if(data.success==true){
							$.each(data.obj, function(i, item) {
								$("#teachersno").html(item.teachersno);
								$("#teachername").html(item.teachername);
								$("#teachermajor").html(item.teachermajor);
								$("#degree").html(item.degree);
								$("#guidemin").html(item.guidemin);
								$("#teachersex").html(item.teachersex);
								$("#guidemax").html(item.guidemax);
							});
						}else{
							alert(data.msg) ;
						}
	...
	<body onload="showMessage()">
		<div style="width: 100%;height: 100%;overflow-y:scroll;">
			...
			<table border="1" cellpadding="0" cellspacing="0" align="center">
				...
				<tbody>
					<tr>
						...
						<td id="teachersno" style="width:16%;"></td>
						<td style="width:17%;">
							<div align="center">
								姓&nbsp;&nbsp;&nbsp;&nbsp;名
							</div>
						</td>
						<td id="teachername" colspan="2">
							&nbsp;
						</td>
						<td rowspan="7" style="text-align:center;overflow:hidden;vertical-align: middle;">
							<div style="width:90px; height:105px; border:1px solid #B3B5B4;">
								<img id="photo" name="photo" width="90px" height="105px" />
							</div>
						</td>
					</tr>
					<tr>
			...
			<iframe style="display:none;" id="hidFrm" name="hidFrm">
			</iframe>

		<!-- 	<div class="ibox-content">
   				 <div class="row">
        			<div id="crop-avatar" class="col-md-6">
            			<div class="avatar-view" title="测试图片上传">
                			<img src="" alt="预览图片" id="images">
            			</div>
        			</div>
    			</div>
			</div> -->
			...
			<div class="modal fade" id="avatar-modal" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog" tabindex="-1">
			    <div class="modal-dialog modal-lg">
			        <div class="modal-content">
			            <form class="avatar-form" action="teacher/teachermessage/uploadImage" enctype="multipart/form-data" method="post">
