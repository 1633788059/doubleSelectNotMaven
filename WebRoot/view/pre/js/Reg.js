...
Reg.Valited = {
    ...
    Mobile: function (ctrl) {
        ...
        GetRemoteContent(Reg.ValitedUrl + "ValidatorIsMobile", { Mobile: value }, ctrl, Reg.Valited.CallBackMobile);
    },
    ...
    SendCodeClick: function (ctrl, mobileCtrl) {
        ...
        GetRemoteContent(Reg.ValitedUrl + "SendVerifyCode", { UserID: UserID, Mobile: mobile }, ctrl, Reg.Valited.SendVerifyCodeCallBack);
    },
